...
do
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 15 --retrain 1 --badsample_prop 0.6 --acc_stopping 0 --frac 0.4 --batch_size 64 --weight_decay 0
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 15 --retrain 1 --badsample_prop 0.4 --acc_stopping 0 --frac 0.4 --batch_size 64 --weight_decay 0
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 15 --retrain 1 --badsample_prop 0.2 --acc_stopping 0 --frac 0.4 --batch_size 64 --weight_decay 0
