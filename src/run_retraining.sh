...
do
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 3 --retrain 1 --badsample_prop 0.2
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 3 --retrain 1 --badsample_prop 0.4
    ...
    python retraining.py --dataset fmnist --setting 2 --processes $PROCESSES --badclient_prop $BAD_CLIENT_PROP --num_users 10 --local_ep 3 --retrain 1 --badsample_prop 0.6
