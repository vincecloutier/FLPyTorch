...
def args_parser():
    ...
    parser.add_argument('--num_categories_per_client', type=int, default=5, help= "Number of categories per client in non-iid setting.")
    parser.add_argument('--badsample_prop', type=float, default=0.75, help= "Proportion of mislabeled/noisy samples per client in mislabeled/noisy setting.")
