...
def args_parser():
    ...
    parser.add_argument('--noise_proportion', type=float, default=0.4, help= "Proportion of noisy samples per client in noisy setting.")
    parser.add_argument('--alpha', type=float, default=0.5, help= "Alpha parameter for noisy setting.")
